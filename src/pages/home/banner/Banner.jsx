...
const Banner = () => {
    ...
    useEffect(() => {
        ...
        const bg = (url?.backdrop || 'https://image.tmdb.org/t/p/original') + bannerMovie?.backdrop_path;
    ...
    return (
        ...
        <div className='w-full h-full min-h-auto bg-teal-800 text-white  z-0 overflow-hidden'>
            {loading || !background ? (
                <div className="skeleton w-screen min-h-screen bg-teal-800 animate-pulse"></div>
            ) : (
